...
#and using an externally defined cut-off to remove outliers and a 5 step algorithm to identify outliers

#METHOD NAME: General cut-off with algorithm (GCO-A)
