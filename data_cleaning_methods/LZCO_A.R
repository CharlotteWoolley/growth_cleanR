...
#and using an internally defined cut-off (longitudinal z-score) and a 5 step algorithm to identify outliers

#METHOD NAME: Longitudinal z-score cut-off with algorithm (LZCO_A)
